...
exports.requestAndFormat = async (job,step,choices = ["all"]) => {
    ...
    const jobGear = await axios.get(`https://beta.xivapi.com/api/1/search?sheets=Item&fields=Icon,Url,Name,EquipSlotCategory&query=%2BLevelItem=${ilvl}%20%2BClassJobCategory.${job.trim()}%20%2BIsUntradable=false&sort_field=LevelItem&sort_order=desc&limit=11`)
